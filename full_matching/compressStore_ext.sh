...
nice -n 10 $CODE_PATH/compressStore.bin \
       ...
       -o ~/memexdata/Dataset/processed/0006_BackpageExtended/Features/CNN/pool5_normed_compressed/ \
       -k /home/rgirdhar/memexdata/Dataset/processed/0006_BackpageComplete/Images/lists/feature_ids.txt \
       -s 8236837
